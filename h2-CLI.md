...
Kolmen ohjelman asennus samanaikaisesti; '
...
Vim CLI työkalun käyttö, luotiin ylimääräinen txt tiedosto melkein sama kuin micro;
...
Wget CLI työkalun käyttö, ladattu kuvatiedosto koneelle netistä; 
...
Nmap CLI työkalun käyttö, tarkistettiin localin portit jne; 
...
Tree alussa ennen kun siirrettiin tiedostoja " mv ";
...
Siirretty tiedostoja halutun kansion alle; 
...
FHS kansio esittely /etc/ | /media/ | /var/log/ | /home/arttul/ | /home/ | / (root directory);
...
Tutkittu Rautaa sudo lshw -short -sanitize;
...
Testailtu muuten vain history toiminta; (käytetty man history kun salasana piti poistaa sieltä history -d "numero")
...
Micro editoriin plugin asennus;
...
Micro editorissa ei kuitenkaan näy uutta pluginia;...
...
Käynnistää micro editorin uudestaan;
